...
#define SER_MIC_UPLINK "micuplink"
#define SER_MIC_DEVICE "micdevice"
...
void StreamingPreferences::reload()
{
    ...
    enableMicUplink = settings.value(SER_MIC_UPLINK, false).toBool();
    micDeviceName = settings.value(SER_MIC_DEVICE).toString();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_MIC_UPLINK, enableMicUplink);
    settings.setValue(SER_MIC_DEVICE, micDeviceName);
}
